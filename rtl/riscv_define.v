...
`define INS_TYPE_AUIPC  7'b0010111
`define INS_TYPE_NOP    32'h00000013
`define INS_TYPE_NOP_OP 7'b0000001
`define INS_TYPE_MRET   32'h30200073
`define INS_TYPE_RET    32'h00008067

`define INS_TYPE_FENCE  7'b0001111
`define INS_TYPE_ECALL  32'h73
